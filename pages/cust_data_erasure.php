            ...
            <div class="row" id="main" >
				...
				<?php 
					...
					// $query="INSERT INTO shopdetails(`details`) VALUES ('".$webhook_ordercontent1."')";
					 ...
					 $query1="INSERT INTO  cus_erasure_data(`shop_id`,`shop_domain`,`customer_id`,`email`,`phone`,`orders_requested`) 
                     ...
                     mysqli_query($con,$query1);
						...
						$subject = 'GDPR Request for delete customer information';
						$message = 'We are requesting to detele your data in shopify store.';
